...
import VideoStudio from "./video-studio-v7";

const videoStudioUrl = "https://targetbud.vercel.app/video-studio";

export const metadata: Metadata = {
  title: "Free Online Video Editor — TargetBud Video Studio",
  description: "Create videos in your browser with TargetBud Video Studio. Import video, photos and audio, edit a multi-track timeline, animate clips with keyframes, add filters, effects, masks, captions and audio, and export your project.",
  keywords: [
    "online video editor", "free video editor", "browser video editor", "video trimmer", "video splitter",
    "multi track video editor", "keyframe video editor", "short video maker", "TargetBud Video Studio",
  ],
