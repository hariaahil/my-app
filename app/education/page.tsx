...
const tracks = [
  ...
  { title: "Subject practice", text: "Choose one subject and keep practicing it until your evidence shows improvement. You do not have to follow a fixed order.", href: "/study", label: "Start subject practice" },
  { title: "Assessment first", text: "Take a diagnostic or assessment before studying. Use the results to identify gaps and build the next study block.", href: "/study", label: "Take an assessment" },
  { title: "Full preparation", text: "Move through learning, practice, revision and mock exams at your own pace. The system keeps the end goal focused on mastery.", href: "/study", label: "Build a plan" },
];
